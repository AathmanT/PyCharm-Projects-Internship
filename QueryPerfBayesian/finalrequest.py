...
###########################################################################################################
# It will calculate throughput by getting global previous time and previous request                       #
# if you run directly you won't get the correct throughput                                                #
# run it with another method calling this which alreaddy have a global previous time and previous request #
###########################################################################################################
        ...
        for line in data_list:
            try:
                ...
                if (throughput):
                    ...
                    print("cr-pr",current_requests," ",previous_requests,"=",current_requests-previous_requests)
                    print("ct-pt",current_time," ",previous_time,"=",current_time-previous_time)
